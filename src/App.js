   ...
   <Router>
    ...
    <section className='mr-5 min-h-[100svh] '>
      <div className='font-inter p-5 text-lg font-semibold '>
        <button className="menu-button ml-5 mt-5 " onClick={toggleMenu}>
          MENU
        </button>
        {isMenuOpen && (
          <div className="menu-dropdown flex w-full h-full ">
            ...
            <div>
              <ul className='pt-60 h-full  '>
                <li className='pb-5 ml-16 leftdiv'> <span className='pr-5'>01</span> <span className='border-b border-teal-600 '>WORK</span></li>
